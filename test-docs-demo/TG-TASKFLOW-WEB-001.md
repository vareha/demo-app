...
**Component**: Task Form Component
**Page**: /task/new
**Feature Tags**: task-creation, task-assignment
**Test Type**: Happy Path
**Priority**: P1
...
- Description: "Create UI mockups for new features"
- Status: "TODO"
- Priority: "HIGH"
- Assigned To: "user123" (valid user ID)
- Click "Create Task" button
**Then**:
- Task created successfully and assigned to user123
- Redirected to /dashboard
- New task visible in list with assigned user
**Verify**:
- Form fields cleared after submit
- API called with correct payload including assigned_to
- Task appears at top of list with correct assignment
...
**Component**: Task Form Component
**Page**: /task/{id}/edit
**Feature Tags**: task-update, task-assignment
**Test Type**: Happy Path
**Priority**: P1
**Prerequisites**: Existing task assigned to User A
**Consumes API**: PUT /api/tasks/{id} (TG-TASKFLOW-API-001)

**Given**: On task detail page for "task123"
**When**: Change assignment from User A to User B → Click "Save"
**Then**:
- Task updated successfully with new assignee
- Returned to detail view
**Verify**:
- Optimistic UI update reflects reassignment
- API call completes successfully
- Task shows new assignee in details
...
**Given**: On task detail page for "task123"
**When**: Set assignment to null → Click "Save"
**Then**:
- Task unassigned successfully
- Returned to detail view without assignee
**Verify**:
- Task shows no assigned user in details
- API call completes successfully
